<template>
  <section id="publishers" class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center font-heading">Browse by Publisher</h2>
...
// Calculate how many publishers to display
const displayPublishers = computed(() => {
  return props.publishers.slice(0, props.limit)
})

// Show "View More" button if there are more publishers than the limit
const showViewMore = computed(() => {
  return props.publishers.length > props.limit
})
</script>
