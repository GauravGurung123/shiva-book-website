<template>
  <div class="min-h-screen bg-gray-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 class="text-4xl font-bold text-gray-800 mb-8 text-center font-heading">Contact Us</h1>
      
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- Contact Information -->
        <div class="bg-white rounded-lg shadow-lg p-8">
          <h2 class="text-2xl font-bold text-gray-800 mb-6 font-heading">Get in Touch</h2>
          
          <div class="space-y-4">
            <div class="flex items-start">
              <div class="bg-gradient-to-br from-primary-500 to-primary-600 text-white p-3 rounded-full mr-4 shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <h3 class="font-semibold text-gray-800 font-heading">Email</h3>
            ...
            <div class="flex items-start">
              ...
              <div>
                <h3 class="font-semibold text-gray-800 font-heading">Phone</h3>
                <p class="text-gray-600">{{ contactPhone }}</p>
              </div>
            </div>

            <div v-if="contactAddress" class="flex items-start">
              <div class="bg-gradient-to-br from-primary-500 to-primary-600 text-white p-3 rounded-full mr-4 shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                <h3 class="font-semibold text-gray-800 font-heading">Address</h3>
          ...
          <!-- Social Media Links -->
          <div v-if="socialLinks.length > 0" class="mt-8 pt-6 border-t border-gray-200">
            <h3 class="font-semibold text-gray-800 mb-4 font-heading">Follow Us</h3>
            <div class="flex space-x-4">
              <a 
                ...
                class="text-gray-600 hover:text-primary-600 transition text-2xl"
